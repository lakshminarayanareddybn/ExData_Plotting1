...
par(mfrow=c(2,2))
#1/4
with(power_cons, plot(DateTime,Global_active_power,type="n",xlab="",ylab="Global Active Power"))
with(power_cons,lines(DateTime,Global_active_power))
#2/4
with(power_cons,plot(DateTime,Voltage,type="n",xlab="datetime",ylab="Voltage"))
with(power_cons,lines(DateTime,Voltage))
#3/4
...
#4/4
with(power_cons,plot(DateTime,Global_reactive_power,type="n",xlab="datetime",ylab="Global_reactive_power"))
with(power_cons,lines(DateTime,Global_reactive_power))
dev.off()